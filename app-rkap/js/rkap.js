...
const RkapApp = {
    ...
    renderDashboard() {
        ...
        container.innerHTML = `
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 animate-fade-in text-slate-100">
                <div class="card-premium p-6 overflow-hidden relative group">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div class="p-3 rounded-xl bg-indigo-500/10 text-indigo-400"><i data-lucide="database" class="w-6 h-6"></i></div>
                        <h3 class="text-slate-400 text-sm font-semibold uppercase tracking-wider">Master Program</h3>
                    </div>
                    <div class="text-4xl font-bold tracking-tight">${totalMaster.toLocaleString()}</div>
                    <div class="mt-4 text-xs text-slate-500">Database rkap_2026.xlsx</div>
                </div>
                ...
                <div class="card-premium p-6 overflow-hidden relative group">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div class="p-3 rounded-xl bg-emerald-500/10 text-emerald-400"><i data-lucide="check-circle" class="w-6 h-6"></i></div>
                        <h3 class="text-slate-400 text-sm font-semibold uppercase tracking-wider">Program Aktif</h3>
                    </div>
                    <div class="text-4xl font-bold tracking-tight">${totalSelected.toLocaleString()}</div>
                    <div class="mt-4 text-xs text-slate-500">Program yang dipilih untuk dijalankan</div>
                </div>
                ...
                <div class="card-premium p-6 overflow-hidden relative group">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div class="p-3 rounded-xl bg-blue-500/10 text-blue-400"><i data-lucide="calendar" class="w-6 h-6"></i></div>
                        <h3 class="text-slate-400 text-sm font-semibold uppercase tracking-wider">Periode</h3>
                    </div>
                    <div id="periode-label" class="text-2xl font-bold tracking-tight">${this.state.filters.month || 'Tahun 2026'}</div>
                    <div id="total-pagu-label" class="mt-4 text-xs ${totalPaguFiltered > 0 ? 'text-emerald-400 font-semibold' : 'text-slate-500'}">
                        Total Pagu: Rp ${totalPaguFiltered.toLocaleString('id-ID')}
                    </div>
                </div>
            </div>

            <!-- Filters & Program List Wrapper -->
            <div class="card-premium h-[calc(100vh-360px)] flex flex-col overflow-hidden animate-fade-in" style="animation-delay: 0.1s">
                <div class="p-6 border-b border-slate-700/50 bg-white/5 space-y-4">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h3 class="font-bold text-lg text-white">Database Program Kerja</h3>
                            <p id="items-count-label" class="text-xs text-slate-500 mt-1">Menampilkan ${totalFiltered.toLocaleString()} dari ${totalMaster.toLocaleString()} item</p>
                        </div>
